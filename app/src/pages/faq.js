...
const FAQ = () => {
    return (
        <>
            <Helmet>
                <title>University IO - FAQ</title>
                <meta name="description" content="Find answers to common questions on the University IO FAQ page. Learn about buying and selling courses, earning certifications, platform features, and more. Get the information you need quickly and easily!" />
            </Helmet>
